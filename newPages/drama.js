...
async function fetchMovie(page) {
  ...
  let cardsHTML = "";
  const url = `https://api.themoviedb.org/3/discover/movie?api_key=476f7b035e2d96e41911d624fa6551e3&with_genres=18&language=pt-BR&page=${page}`;
...
`;
  ...
  titleMovie.innerHTML = "Filmes de Drama";
